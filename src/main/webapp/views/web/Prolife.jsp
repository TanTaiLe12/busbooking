  ...
  <section class="slider" id="spiderman">
    <div class="container">
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#DanhSachKhoaHoc" style="
                pointer-events: none; 
                opacity: 0.5; 
              " role="tab" data-toggle="tab">Chọn Ghế</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#ThongKe"  style="
                pointer-events: none; 
                opacity: 0.6; 
              " role="tab" data-toggle="tab">Thông Tin Khách Hàng</a>
            </li>
        </ul>
        <br />
        <!-- Tab panes -->
